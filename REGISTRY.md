...
| General (Proposed) | `509:833` | Settings page — **Proposed** app/account settings child view (kit nav + "General"): grouped **Appearance** (System) / App Icon · **Notifications & Sounds** · **Language & Region**. Standard iOS General rows; the view is built. The Settings **"Rem"→"General" rename** + final IA is founder-gated (EVOLUTION.md); on-canvas caption marks it Proposed. |
