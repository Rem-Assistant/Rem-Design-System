...
| Agenda scenarios (proposed) | `530:22` | Tasks & Agenda page — **DateNav 3-box stepper** `530:25` (`[‹][ date ][›]`, proposed interpretation of "three rectangles") + **Jump to Today** pill `530:34` (`arrow.uturn.backward`, floating capsule when off-today, `AgendaView.swift:109`). |
